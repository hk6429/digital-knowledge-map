...
'2026-09-12':{visits:554,events:2083,notes:[35,34],sessions:[4,11],today:[41,21],must:['subscription-sync','app-publish','bills','humor-comics','knowledge-vault','project-8fe8cebf04d2c47a'],first:'08:10:33'},
'2026-09-13':{visits:151,events:1072,notes:[23,23],sessions:[3,6],today:[17,9],must:['subscription-sync','knowledge-vault','handoff','review'],first:'00:09:51'}};
