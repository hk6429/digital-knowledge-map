...
export const GROUPS=[
 ...
 ['note-method','筆記與知識組織','language',['課本筆記與心智圖']],
 ['voice-expression','口語表達','creation',['聲音表達與講評','線上課程學習']],
 ['audio-quality','紀錄品質','creation',['錄音品質與回聽']],
 ['class','班級經營','lead',['class-points-299','新手導師','teacher-tycoon']],
 ['equipment','設備與服務','school',['平板借用','校園設備管理']],
 ['admin','校務支持','school',['校務與資訊行政','翰墨文書','校園 LINE Bot 助理']],
 ...
 ['design','教育工具設計','sharing',['AI 工作流程','程式開發與部署','課程與教學設計','YouTube 訂閱同步自動化','iOS App 上架準備']],
 ['write','寫作與表達','creation',['寫作與社群內容','PDF / 投影片','習慣書稿','wenxin-diaolong']],
 ['visual','故事與影像','creation',['影片成品','fuxiao-miling','冷笑話漫畫創作']],
 ['reflect','整理與反思','creation',['成果檢視與覆核','下一步與交接','數位足跡與知識圖譜','知識庫與對話歸檔']],
